...
static PyObject *
_hmac_HMAC_copy(HMACObject *self, PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    if (nargs || (kwnames && PyTuple_GET_SIZE(kwnames))) {
        PyErr_SetString(PyExc_TypeError, "copy() takes no arguments");
        return NULL;
    }
    return _hmac_HMAC_copy_impl(self, cls);
}
...
static PyObject *
_hmac_HMAC_update(HMACObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    #if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
    ...
    msgobj = args[0];
    return_value = _hmac_HMAC_update_impl(self, msgobj);
...
/*[clinic end generated code: output=08128ca3ec77ff06 input=a9049054013a1b77]*/
